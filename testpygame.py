...
while True:
    ...
    angle = math.atan2(position[1] - (playerpos[1]),
    ...
    # print 'draw player com'
    if badtimer <= 0:
        badguys.append([640, random.randint(50, 430)])
        badtimer = 100 - (badtimer1 * 2)
        print 'modi{}'.format(badtimer)
        if badtimer1 >= 35:
            badtimer1 = 35
        else:
            badtimer1 += 5
    ...
    for badguy in badguys:
        ...
        for bullet in arrows:
            ...
            index1 += 1
        index += 1
    # print 'badguysnum{}'.format(len(badguy))
    for badguy in badguys:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            arrows.append([math.atan2(position[1] - (playerpos1[1] + 32),
                                      position[0] - (playerpos1[0] + 26)), playerpos[0], playerpos[1]])
